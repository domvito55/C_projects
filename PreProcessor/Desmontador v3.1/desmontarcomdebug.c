...
**		
**	Chama todas as funções necessárias para desmontar o arquivo pelo Section Header.
**	
**	___________________desmontar.c___________________
**/

void desmontarcomdebug(char *linguagemmaquina, char *linguagemassembly) {
...
============================================================*/
	...
	if(tabela && lin_maquina && codigo_assembly){ 
		...
		====================Gera o código=============================
		=============================================================*/
		p_label=geracodigocomdebug(lin_maquina, &p_dadosbss, &p_newcode, p_tabela, &p_newdata);
